...
class DoctorBotSearchBar extends StatefulWidget {
  const DoctorBotSearchBar({super.key});

  @override
  State<DoctorBotSearchBar> createState() => DoctorBotSearchBarState();
}

class DoctorBotSearchBarState extends State<DoctorBotSearchBar>
