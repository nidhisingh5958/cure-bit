...
class DoctorProfileRepository {
  ...
  Future<DoctorPublicProfile> getDoctorPublicProfile(String doctorId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return DoctorPublicProfile.fromJson(data);
      } else {
        throw Exception(
  ...
  Future<bool> updateDoctorPublicProfile(
    String doctorId,
    DoctorPublicProfile profile,
  ) async {
    try {
  ...
  DoctorPublicProfile _getMockDoctorProfile(String doctorId) {
    return DoctorPublicProfile(
      firstName: 'John',
      lastName: 'Doe',
